...
let to_srv m =
  {
    disj_concat =
      (fun l r ->
        object
          method role_Srv = m.disj_concat l#role_Srv r#role_Srv
        end);
    disj_splitL =
      (fun lr ->
        object
          method role_Srv = m.disj_splitL lr#role_Srv
        end);
    disj_splitR =
      (fun lr ->
        object
          method role_Srv = m.disj_splitR lr#role_Srv
        end);
  }
