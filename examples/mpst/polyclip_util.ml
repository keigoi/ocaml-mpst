...
let secout_or_secin =
  {
    disj_concat =
      (fun l r ->
        object
          method secout = l#secout
          method secin = r#secin
        end);
...
let to_r m =
  {
    disj_concat =
      (fun l r ->
        object
          method role_R = m.disj_concat l#role_R r#role_R
        end);
    disj_splitL =
      (fun lr ->
        object
          method role_R = m.disj_splitL lr#role_R
        end);
    disj_splitR =
      (fun lr ->
        object
          method role_R = m.disj_splitR lr#role_R
        end);
  }
...
let to_c m =
  {
    disj_concat =
      (fun l r ->
        object
          method role_C = m.disj_concat l#role_C r#role_C
        end);
    disj_splitL =
      (fun lr ->
        object
          method role_C = m.disj_splitL lr#role_C
        end);
    disj_splitR =
      (fun lr ->
        object
          method role_C = m.disj_splitR lr#role_C
        end);
  }
